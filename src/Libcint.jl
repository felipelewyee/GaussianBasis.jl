...
export cint1e_kin_sph!,
    cint1e_nuc_sph!, cint1e_ovlp_sph!, cint2c2e_sph!, cint2e_sph!, cint3c2e_sph!
export cint1e_ipkin_sph!,
    cint1e_ipnuc_sph!,
    cint1e_ipovlp_sph!,
    cint1e_ipipovlp_sph!,
    cint2e_ip1_sph!,
...
function cint1e_ipipovlp_sph!(
    buf::Array{Cdouble},
    shls::AbstractArray{<:Integer},
    lib::LCint,
)
    cint1e_ipipovlp_sph!(
        buf,
